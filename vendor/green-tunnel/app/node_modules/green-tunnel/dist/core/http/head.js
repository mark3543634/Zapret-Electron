 ...
 */
export function parseRequestHead(raw) {
...
export function serializeRequestHead(head) {
...
export function getHeader(head, name) {
 ...
 */
export function toOriginForm(head) {
...
export function resolveUpstream(head, defaultPort) {
...
export function splitAuthority(authority, defaultPort) {
    ...
    if (trimmed.startsWith('[')) {
        ...
        if (end < 0)
            throw new ProtocolError(`Malformed IPv6 authority: ${authority}`);
...
function parsePort(raw, authority) {
